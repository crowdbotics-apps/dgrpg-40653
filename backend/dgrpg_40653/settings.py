"""
Django settings for dgrpg_40653 project.
...
WSGI_APPLICATION = 'dgrpg_40653.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dgrpg_40653 API",
    "DESCRIPTION": "API documentation for dgrpg_40653 App",
    "VERSION": "v1",
}
